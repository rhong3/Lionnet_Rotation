...
def rescale_im(directory):
    ...
    for imid in dirs:
        try:
            im = imageio.imread(directory + imid + '/label/' + 'WT_Combined.png')
            ...
            imageio.imsave(directory + imid + '/label/' + 'WT_Combined_pad.png', im.astype(np.uint8))
        except:
            continue


rescale_im('../stage_1_test/')